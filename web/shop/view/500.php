...
<body>
    <header>
        ...
        <nav>
            <?php include $_SERVER['DOCUMENT_ROOT'] . '/phpmotors/CSE341/week_03/shop/modules/nav.php'; ?>
        </nav>
    </header>

    <main>
        <h1>Server Error :(</h1>
        <p>Sorry, our servers seem to be experiencing technical difficulties. Please try again later.</p>
